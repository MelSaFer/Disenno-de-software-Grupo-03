...
/*------------------------------------------
    * Data for Users
-------------------------------------------*/
export const user1 = new DTOUser(1, 
    'user', 
    [{productId: 1, quantity: 1},
    {productId: 2, quantity: 2}]);
export const user2 = new DTOUser(2,
    'user2', 
    [{productId: "1", quantity: 1},
    {productId: "2", quantity: 2},
    {productId: "3", quantity: 3}]);
export const user3 = new DTOUser(3,
    'user3',
    [{productId: "1", quantity: 1},
    {productId: "2", quantity: 2},
    {productId: "3", quantity: 3}]);

export const user4 = new DTOUser(1,
    'user1',
    [{productId: "1", quantity: 1},
    {productId: "2", quantity: 2},
    {productId: "3", quantity: 3}]);
